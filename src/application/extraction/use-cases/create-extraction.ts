import type { IExtractionLLMProvider } from "@/domain/extraction/ports/extraction-llm-provider.port";
import type { ITranscriberLLMProvider } from "@/domain/extraction/ports/transcriber-llm-provider.port";
